...
const socket = io("http://localhost:3200/api");
...
const TrueFalsePollResponses = () => {
      ...
      setChartData((prevData) => {
        ...
        data.forEach((newData) => {
          const index = updatedData.findIndex(
            (d) => d.questionText === newData.questionText
          );
          if (index > -1) {
  ...
  return (
    <>
      ...
      >
        <option value="pie">
          Pie Chart <Icon as={FaChartPie} />
        </option>
        <option value="bar">
          Bar Chart <Icon as={FaChartBar} />
        </option>
        <option value="line">
          Line Chart <Icon as={FaChartLine} />
        </option>
      </Select>
