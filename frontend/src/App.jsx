          ...
          <Flex>
            ...
            >
              <Routes>
                ...
                />
                <Route
                  path="/true-false-poll"
                  element={<CreateTrueFalsePoll />}
                />
                <Route
                  path="/get-true-false-poll"
                  element={<AllTrueFalsePolls />}
                />
                <Route
                  path="/true-false-poll/:pollId"
                  element={<AttendTrueFalsePoll />}
                />
                {/* <Route
                  path="/true-false-poll/results/:pollId"
                  element={<TrueFalsePollResponses />}
                /> */}
                <Route
                  path="/5+-polling-options"
                  element={<PollingOptionsPage />}
                />
                <Route
                  path="/get-started-for-free"
